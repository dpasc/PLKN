...
file_path = "//home//daman//Projects//plkn/Application//pythonScraper//"
...
open('wow.xlsx','wb').write(result.content)

#Conver to CSV
data_xls = pd.read_excel(file_path + "wow.xlsx")
data_xls.to_csv(file_path + "wow.csv", index=False)

#Delete XLSX File
os.remove(file_path + "wow.xlsx")